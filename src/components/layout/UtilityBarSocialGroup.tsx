...
type UtilityBarSocialGroupProps = {
  socialFacebook?: string;
  socialLinkedin?: string;
  socialInstagram?: string;
};

export function UtilityBarSocialGroup({
  socialFacebook,
  socialLinkedin,
  socialInstagram,
}: UtilityBarSocialGroupProps) {
  if (!socialFacebook && !socialLinkedin && !socialInstagram) {
    return null;
  }

  return (
    <div
      className="hidden lg:flex items-center gap-1 shrink-0 pl-3 border-l border-white/15"
      aria-label="Social media"
    >
      {socialFacebook && (
        <SocialIcon href={socialFacebook} label="Facebook" variant="inverse">
      ...
      {socialLinkedin && (
        <SocialIcon href={socialLinkedin} label="LinkedIn" variant="inverse">
          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
      ...
      {socialInstagram && (
        <SocialIcon href={socialInstagram} label="Instagram" variant="inverse">
          <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
