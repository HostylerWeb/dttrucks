...
export function DealerStats() {
  return (
    <section className="page-section bg-inverse-surface overflow-hidden relative">
      ...
      <div className="absolute top-0 right-0 opacity-[0.05] pointer-events-none translate-x-1/4" aria-hidden>
        <svg className="w-[280px] lg:w-[400px] h-auto text-white" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="page-container relative z-10">
        <div className="text-center mb-8 sm:mb-12 lg:mb-14">
          ...
          <h2 className="font-headline text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 max-w-3xl mx-auto leading-tight">
            {DEALER_HEADING}
          </h2>
