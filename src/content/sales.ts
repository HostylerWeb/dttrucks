export const salesIntro = {
  ...
  specialistNote:
    "Authorised Isuzu dealer support for new trucks, driveaways, fleet replacements and finance.",
};
...
export const salesWhyChoose = {
  ...
  items: [
    ...
    {
      icon: "assignment",
      title: "O Licence assistance",
      description:
        "Support with O Licence procedures and issues, including advice on compliant vehicle specifications for your operation.",
    },
    {
      icon: "payments",
