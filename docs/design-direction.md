...
- **Palette:** Isuzu red stays the accent (`primary` / `primary-container`) for CTAs and highlights. Page backgrounds favour **white** and light grey surfaces (`surface-container-*`), not heavy full-width red/black bands.
